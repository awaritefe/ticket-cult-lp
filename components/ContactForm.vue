<template>
	<div id="contact-form" class="bg-black py-16 sm:py-24 lg:py-32">
		...
		>
			<h2
				class="max-w-xl text-3xl font-semibold tracking-tight text-primary sm:text-4xl lg:col-span-7"
			>
				Be first to know when Ticket Cult drops and keep updated.
			</h2>
			<form class="w-full max-w-md lg:col-span-5 lg:pt-2">
				<div class="flex gap-x-4">
					...
					<button
						type="submit"
						class="flex-none rounded-md bg-primary px-3.5 py-2.5 text-sm font-semibold text-black shadow-xs hover:bg-white cursor-crosshair focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
					>
						Subscribe
					</button>
				</div>
